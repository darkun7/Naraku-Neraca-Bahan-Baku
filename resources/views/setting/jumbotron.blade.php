    ...
    <div class="container-fluid">
      ...
      <div class="row heading-bg">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
          ...
          <li class="active"><span>Jumbotron</span></li>
          </ol>
        </div>
        <!-- /Breadcrumb -->
      </div>
      ...
      <div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Jumbotron</h6>
									</div>
                            ...
                            <div class="form-group">
															<label for="exampleInputuname_3" class="col-sm-3 control-label">Judul Sampul</label>
															<div class="col-sm-9">
																	<textarea class="summernote" name="jumbotron_title" rows="2" cols="10" required style="height: 30px">{{$web['jumbotron_title']}}</textarea>
															</div>
														</div>
                            <div class="form-group">
                              <label for="exampleInputweb_31" class="col-sm-3 control-label">Sub-judul Sampul</label>
                              <div class="col-sm-9">
                                  <textarea class="summernote" name="jumbotron_text" rows="4" cols="40" required>{{$web['jumbotron_text']}}</textarea>
                              </div>
                            </div>
