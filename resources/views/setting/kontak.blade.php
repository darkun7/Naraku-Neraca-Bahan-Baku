    ...
    <div class="container-fluid">
      ...
      <div class="panel panel-default card-view">
                            ...
                            <div class="form-group">
															<label for="exampleInputuname_3" class="col-sm-3 control-label">Nomor Whatsapp penerima pesanan</label>
															<div class="col-sm-9">
																	<input type="number" class="form-control" name="nomor_wa" placeholder="Contoh: 6281394626994" value="{{$web['nomor_wa']}}" required>
															</div>
														</div>
                            <div class="form-group">
                              <label for="exampleInputweb_31" class="col-sm-3 control-label">Link Instagram</label>
                              <div class="col-sm-9">
                                  <input type="text" class="form-control" name="instagram" placeholder="Contoh: mitratani2bws" value="{{$web['instagram']}}" required>
                                  <p>Jika username instagram merupakan <code>@mitratani2bws</code> maka cukup isi dengan <code>mitranati2bws</code></p>
                              </div>
                            </div>
