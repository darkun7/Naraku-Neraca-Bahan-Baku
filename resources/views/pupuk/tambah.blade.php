    ...
    <div class="container-fluid">
      ...
      <div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Tambah Pupuk</h6>
									</div>
										...
										<div class="row">
											<div class="col-sm-12 col-xs-12">
												<div class="form-wrap">
													...
													<form class="form-horizontal" method="POST" action="{{ route('pupuk.store') }}">
                            @csrf
														<div class="form-group">
															<label for="exampleInputuname_3" class="col-sm-3 control-label">Jenis Pupuk</label>
															<div class="col-sm-9">
																	<input type="text" class="form-control" name="nama" placeholder="Jenis Pupuk" required>
															</div>
														</div>
														<div class="form-group">
															<label for="exampleInputEmail_3" class="col-sm-3 control-label">Deskripsi</label>
															<div class="col-sm-9">
                                  <textarea class="form-control" name="deskripsi" rows="4" cols="80" required></textarea>
															</div>
														</div>
														<div class="form-group">
															<label for="exampleInputweb_31" class="col-sm-3 control-label">Harga Jual</label>
															<div class="col-sm-9">
																	<input type="number" class="form-control" name="harga" placeholder="Contoh: 25000" required>
															</div>
														</div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                  <label for="exampleInputweb_31" class="col-sm-3 control-label">Bahan</label>
                                  <select class="form-control" name="id_bahan[]" required>
                                      <option value="###"> data</option>
                                  </select>
                                </div>
                                <div class="col-sm-3">
                                  <label for="exampleInputweb_31" class="col-sm-3 control-label">Rasio</label>
                                <input type="number" class="form-control" name="rasio[]" value="0" required>
                                </div>
                                <div class="col-sm-2">
                            ...
                            <div class="form-group">
															...
															<div class="col-sm-9">
                                  <div class="mt-40">
                											<input type="file" id="input-file-max-fs" class="dropify" data-max-file-size="2M" required />
                									</div>
															</div>
														</div>
